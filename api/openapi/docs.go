...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.BatchFavoriteStatusRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.BatchFollowStatusRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "default": "relevance",
                        "description": "排序方式: relevance, latest, hot",
                        "name": "sort",
                        "in": "query"
                    },
                    {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.SearchVideoData"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "dto.BatchFavoriteStatusRequest": {
            "type": "object",
            "required": [
                "video_ids"
            ],
        ...
        "dto.SearchVideoData": {
            ...
            "properties": {
                ...
                "videos": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.SearchVideoInfo"
                    }
                }
            }
        },
        ...
        "dto.VideoInfo": {
            ...
            "properties": {
                "author": {
                    "$ref": "#/definitions/dto.AuthorBrief"
                },
                "author_id": {
                    "type": "integer"
                },
